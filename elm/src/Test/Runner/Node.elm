...
[
  ...
  },
  {
    ...
    "failures": [
      {
        "given": null,
        "message": "\\u001b[31m\\u001b[1mUNEXPECTED ERROR MESSAGE\\u001b[22m\\u001b[39m\\n\\nI was looking for the error for module `A` with the following message:\\n\\n  `Exposed functin or value `a` is never used outside this module`\\n\\nbut I found the following error message:\\n\\n  `Exposed function or value `a` is never used outside this module`",
        "reason": {
          "type": "Custom",
          "data": "\\u001b[31m\\u001b[1mUNEXPECTED ERROR MESSAGE\\u001b[22m\\u001b[39m\\n\\nI was looking for the error for module `A` with the following message:\\n\\n  `Exposed functin or value `a` is never used outside this module`\\n\\nbut I found the following error message:\\n\\n  `Exposed function or value `a` is never used outside this module`"
        }
      }
    ]
  },
